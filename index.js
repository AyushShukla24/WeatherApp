...
// const API_KEY='484f80491c04c9a3f8aede4a5729cfb8';
// currentTab.classList.add("current-tab");

// function switchTab(clikcedTab){
//     if(currentTab!=clikcedTab){
//         currentTab.classList.remove("current-tab");
//         currentTab=clikcedTab;
//         currentTab.classList.add("current-tab");
//     }
...
//     }
//     else{
//         //weather tab visible krna hai
//         searchForm.classList.remove("active");
//         userInfoContainer.remove("active");
//         // pura data weather tab ka wapis lane ke liye
...
// //check if coortinates already present in session storgae
// function getfromSessionStorage(){
//     const localcoordinates=sessionStorage.getItem("user-coordinates");
//     if(!coordinates){
//         // aggr local cordinates nhi mile toh
...
//         apiErrorBtn.addEventListener("click", fetchWeatherinfo);
//     }
// }
